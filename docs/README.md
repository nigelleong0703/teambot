...
- `modules/agent-runtime-architecture.md`
  - Presentation-friendly architecture walkthrough for the core runtime path:
    `app -> service -> runtime -> graph -> reason -> execution -> memory/tools/providers`.
